...
module nios2_system_mm_interconnect_0 (
	...
	wire   [4:0] rsp_mux_src_channel;                                                             // rsp_mux:src_channel -> nios2_cpu_data_master_agent:rp_channel
	...
	wire   [4:0] rsp_mux_001_src_channel;                                                         // rsp_mux_001:src_channel -> nios2_cpu_instruction_master_agent:rp_channel
	...
	wire  [94:0] cmd_mux_001_src_data;                                                            // cmd_mux_001:src_data -> nios2_cpu_debug_mem_slave_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                           // nios2_cpu_debug_mem_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [4:0] cmd_mux_001_src_channel;                                                         // cmd_mux_001:src_channel -> nios2_cpu_debug_mem_slave_agent:cp_channel
	...
	wire  [95:0] pio_led_s1_agent_rf_source_data;                                                 // pio_led_s1_agent:rf_source_data -> pio_led_s1_agent_rsp_fifo:in_data
	...
	wire  [95:0] pio_led_s1_agent_rsp_fifo_out_data;                                              // pio_led_s1_agent_rsp_fifo:out_data -> pio_led_s1_agent:rf_sink_data
	...
	wire  [94:0] cmd_mux_003_src_data;                                                            // cmd_mux_003:src_data -> pio_led_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                           // pio_led_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [4:0] cmd_mux_003_src_channel;                                                         // cmd_mux_003:src_channel -> pio_led_s1_agent:cp_channel
	...
	wire  [95:0] pio_dipsw_s1_agent_rf_source_data;                                               // pio_dipsw_s1_agent:rf_source_data -> pio_dipsw_s1_agent_rsp_fifo:in_data
	...
	wire  [95:0] pio_dipsw_s1_agent_rsp_fifo_out_data;                                            // pio_dipsw_s1_agent_rsp_fifo:out_data -> pio_dipsw_s1_agent:rf_sink_data
	...
	wire         cmd_mux_004_src_valid;                                                           // cmd_mux_004:src_valid -> pio_dipsw_s1_agent:cp_valid
	wire  [94:0] cmd_mux_004_src_data;                                                            // cmd_mux_004:src_data -> pio_dipsw_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                           // pio_dipsw_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [4:0] cmd_mux_004_src_channel;                                                         // cmd_mux_004:src_channel -> pio_dipsw_s1_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                                   // cmd_mux_004:src_startofpacket -> pio_dipsw_s1_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                                     // cmd_mux_004:src_endofpacket -> pio_dipsw_s1_agent:cp_endofpacket
	...
	wire  [94:0] nios2_cpu_debug_mem_slave_agent_rp_data;                                         // nios2_cpu_debug_mem_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [94:0] pio_led_s1_agent_rp_data;                                                        // pio_led_s1_agent:rp_data -> router_005:sink_data
	...
	wire         pio_dipsw_s1_agent_rp_valid;                                                     // pio_dipsw_s1_agent:rp_valid -> router_006:sink_valid
	wire  [94:0] pio_dipsw_s1_agent_rp_data;                                                      // pio_dipsw_s1_agent:rp_data -> router_006:sink_data
	wire         pio_dipsw_s1_agent_rp_ready;                                                     // router_006:sink_ready -> pio_dipsw_s1_agent:rp_ready
	wire         pio_dipsw_s1_agent_rp_startofpacket;                                             // pio_dipsw_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         pio_dipsw_s1_agent_rp_endofpacket;                                               // pio_dipsw_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire         pio_dipsw_s1_agent_rdata_fifo_src_valid;                                         // pio_dipsw_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] pio_dipsw_s1_agent_rdata_fifo_src_data;                                          // pio_dipsw_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         pio_dipsw_s1_agent_rdata_fifo_src_ready;                                         // avalon_st_adapter_004:in_0_ready -> pio_dipsw_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_004_out_0_valid;                                               // avalon_st_adapter_004:out_0_valid -> pio_dipsw_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_004_out_0_data;                                                // avalon_st_adapter_004:out_0_data -> pio_dipsw_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_004_out_0_ready;                                               // pio_dipsw_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire   [0:0] avalon_st_adapter_004_out_0_error;                                               // avalon_st_adapter_004:out_0_error -> pio_dipsw_s1_agent:rdata_fifo_sink_error
	...
	nios2_system_mm_interconnect_0_router_003 router_003 (
	...
	nios2_system_mm_interconnect_0_router_003 router_004 (
	...
	nios2_system_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                               //       clk.clk
		.reset               (nios2_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_system_mm_interconnect_0_cmd_mux_001 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                               //       clk.clk
		.reset               (nios2_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_system_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (clk_0_clk_clk),                               //       clk.clk
		.reset              (nios2_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
