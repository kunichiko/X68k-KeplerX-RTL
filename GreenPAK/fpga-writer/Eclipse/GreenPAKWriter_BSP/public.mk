...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../QuartusII/nios2/nios2_system.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x4f000
SOPC_SYSID_FLAG += --sidp=0x4f000
ELF_PATCH_FLAG  += --sidp 0x4f000

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1683261271
SOPC_SYSID_FLAG += --timestamp=1683261271
ELF_PATCH_FLAG  += --timestamp 1683261271
